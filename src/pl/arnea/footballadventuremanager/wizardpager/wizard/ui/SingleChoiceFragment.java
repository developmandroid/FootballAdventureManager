...
import pl.arnea.footballadventuremanager.wizardpager.wizard.model.SingleFixedChoicePage;
...
public class SingleChoiceFragment extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        GlobalData.MYCLUBID = position;


        Log.d("FAM", "League: " + position);
        Log.d("FAM", "Club: " + position);
