...
package pl.arnea.footballadventuremanager.wizardpager.wizard.ui;
...
import pl.arnea.footballadventuremanager.wizardpager.wizard.model.ReviewItem;
...
public class ReviewFragment extends ListFragment implements ModelCallbacks {
    public static List<String> newGameChoose;
    ...
    public void getReviewData() {
        newGameChoose = new ArrayList<String>();
        for (int i = 0; i < mCurrentReviewItems.size(); i++) {
            ReviewItem reviewItem = mCurrentReviewItems.get(i);
            String value = reviewItem.getDisplayValue();
            newGameChoose.add(value);
    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
            ...
            View rootView = inflater.inflate(R.layout.wizardpager_list_item_review, container, false);
